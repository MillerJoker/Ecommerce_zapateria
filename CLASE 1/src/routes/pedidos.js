...
import { realizarPedido, obtenerPedidos, obtenerDetallePedido, actualizarPedido, eliminarPedido } from "../controllers/pedidos_controller.js";
import { asynHandler } from "../middlewares/avanzado.js";
import { verifyToken } from "../middlewares/verifyToken.js";

const router = Router();
router.post("/realizarPedido", verifyToken, asynHandler(realizarPedido));
